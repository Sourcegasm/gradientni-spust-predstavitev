\paragraph{}
Odvod neke funkcije $f(x)$ v to"cki $x_0$ je strmina funkcije v tej to"cki. Odvod je pozitiven "ce funkcija nara"s"ca in negativen, "ce funkcija pada. Ve"cji kot je odvod, bolj strma je funkcija v dani to"cki. Odvod funkcije $f(x)$, ki ga ozna"cimo z $f'(x)$, nam torej pove, kakšen je koeficient tangente na graf fukncije $ f(x) $ v točki $x_0$.
