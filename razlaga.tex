...
\begin{document}
	...
	Ker je točk preveč, ne moremo najti elipse, na kateri bodo ležale vse tocke. Zato pokusamo najti stožnico (elipso), ki se točkam najbolje prilega. Za točko $T_i$ velja:
	$$\varepsilon_i = Ax_i^2 + Bx_iy_i + Cy_i^2 + Dx_i + Ey_i + F$$
	Pri čemer je $\varepsilon_i$ napaka v tej tocki. Iščemo najboljše parametre $A$, $B$, $C$, $D$, $E$ in $F$, tako da bo skupna napaka čim manjša.
	...
	Izračunamo odvode za to funkcijo, po vseh spremenljivkah.
	...
	Gradient nam pove smer največjega naraščanja funkcije. Gradient funkcije f(x) je definiran kot:
